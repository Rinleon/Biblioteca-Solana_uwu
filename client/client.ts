...
await agregarJuego("R.E.P.O",170,"xbox","Horror");
await agregarJuego("Metal slug ",170,"xbox","ACCION");
await agregarJuego("Tomb raider",170,"xbox","ACCION");
await cambiarDisponibilidad("Devil may cry 4");
...
async function agregarJuego(nombre:string,precio:number,plataforma:string,genero:string){
